 ...
 *
 * Here I'm checking whether, for a given K and migration rate, the libration amplitude will
 * significantly change for different mass draws from my MCMC posterior distribution. 
 * Hopefully not...
 *
 */
